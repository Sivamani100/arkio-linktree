...
- **Icons**: [Iconsax React Native](https://iconsax.io/)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/Sivamani100/arkio-linktree.git
   cd arkio-linktree
   ```
...
- Scan the **QR code** with the Expo Go app (Android) or Camera app (iOS) to run on your phone.
